...
from routing.prudent_caster.prudent_caster import PrudentCaster
...
class Drone:
    ...
    def __init__(self,
        ...
        self.routing_protocol = PrudentCaster(self.simulator, self)
        ...
        # use prudentCaster method to generate data_packet()

        # self.env.process(self.receive())

        self.env.process(self.prudent_receive())
